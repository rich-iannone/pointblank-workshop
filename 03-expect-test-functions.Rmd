...
There are 35 `expect_*()` functions, which is a lot. It's actually somewhat overwhelming at first. If you wanted to test your dataset in the **testthat** framework, a nice beginning approach might be to take the dataset and do two things in sequence:
...
The collection of `test_*()` functions are used to give us a single `TRUE` or `FALSE`.
